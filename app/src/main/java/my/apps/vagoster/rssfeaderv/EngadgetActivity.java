...
public class EngadgetActivity extends Activity implements OnItemClickListener
{
...
public final String RSSFEEDOFCHOICE = "http://www.engadget.com/rss.xml";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.engadget_layout);
        
        if(checkInternetConnection()){
        	showProgress = ProgressDialog.show(EngadgetActivity.this, "","Loading. Please wait...", true);
            new LoadingTask().execute(RSSFEEDOFCHOICE);
  		}
  		else{
  			Log.d("network", "No network");
  			Toast.makeText(EngadgetActivity.this, "No Network Available", Toast.LENGTH_SHORT).show();
  		}
    }
    ...
    private void UpdateDisplay()
    {
        ...
        ListView itemlist = (ListView) findViewById(R.id.itemlist_en);
     ...
     public void onItemClick(AdapterView parent, View v, int position, long id)
     {
    	 ...
    	 Intent itemintent = new Intent(this,ShowEngadgetDescriptionActivity.class);
     ...
     public class LoadingTask extends AsyncTask<String, Void, String> {
    		...
    		protected void onPostExecute(String s) {
    			EngadgetActivity.showProgress.dismiss();
    			UpdateDisplay();
    		...
    		private RSSFeed getFeed(String urlToRssFeed)
    	    {
    	    	try
    	    	{
    	           ...
    	           EngadgetRSSHandler theRssHandler = new EngadgetRSSHandler();
    	           // assign our handler
