...
public class ShowEngadgetDescriptionActivity extends Activity 
{
	...
	public void onCreate(Bundle icicle) 
    {
        ...
        /*if(theImage!=null){
        	showProgressDesc = ProgressDialog.show(ShowEngadgetDescriptionActivity.this, "","Loading Description. Please wait...", true);
        	lt.execute(theImage);
        }*/
