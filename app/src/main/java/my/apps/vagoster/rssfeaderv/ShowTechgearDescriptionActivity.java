...
public class ShowTechgearDescriptionActivity extends Activity 
{
	...
	public void onCreate(Bundle icicle) 
    {
        ...
        if(theImage!=null){
        	showProgressDesc = ProgressDialog.show(ShowTechgearDescriptionActivity.this, "","Loading Description. Please wait...", true);
        	lt.execute(theImage);
        }
    ...
    public class LoadingTask extends AsyncTask<String, Void, String>{
		...
		protected void onPostExecute(String s) {
			...
			ShowTechgearDescriptionActivity.showProgressDesc.dismiss();
			ImageView img = (ImageView) findViewById(R.id.imageDesc);
			img.setImageBitmap(bitmap);
		}
